...
public class Result extends AppCompatActivity {
    ...
    TextView txt_name, txt_nim, txt_answer, txt_sugest;
    int userId, answerId;
    BarChart barChart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar mtoolbar = findViewById(R.id.result_toolbar);
        ...
        txt_nim = findViewById(R.id.result_nim);
        txt_name = findViewById(R.id.result_name);
        txt_answer = findViewById(R.id.Result_Answer);
        txt_sugest = findViewById(R.id.Result_sugestion);
        barChart = findViewById(R.id.barchart);
//
//        txt_nim.setText("" + userId + "," + answerId);
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                PutData putData = new PutData("http://192.168.0.125/Multidisplin/getAnswerDetail.php", "POST", field, data);
                if (putData.startPut()) {
                    if (putData.onComplete()) {
//                        txt_name.setText(answerId);
                        try {
                            JSONObject obj = new JSONObject(putData.getResult());
                            txt_nim.setText(String.valueOf(obj.getInt("nim")) );
                            txt_name.setText(obj.getString("name"));
                            txt_answer.setText(obj.getString("answer"));

                            essaiCorrection(obj.getInt("id"));
                            essaiGrade(obj.getInt("id"));
                    ...
                    if (putData.onComplete()) {
                        try {
                            ...
                            if (mistake.get(0).equals("null")){
                                txt_sugest.setText("No Error on Grammar");
                            }else {
